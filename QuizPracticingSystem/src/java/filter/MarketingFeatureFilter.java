...
@WebFilter(
        filterName = "MarketingFeatureFilter",
        urlPatterns = {"/jsp/postDetail.jsp", "/PostDetailController"
        })

public class MarketingFeatureFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("MarketingFeatureFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("MarketingFeatureFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("MarketingFeatureFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("MarketingFeatureFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("MarketingFeatureFilter()");
        }
        StringBuffer sb = new StringBuffer("MarketingFeatureFilter(");
