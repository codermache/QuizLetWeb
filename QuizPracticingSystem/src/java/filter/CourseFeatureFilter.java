...
@WebFilter(
        filterName = "CourseFeatureFilter",
        urlPatterns = {"/jsp/courseContentDetail.jsp", "/jsp/courseContentList.jsp", 
                        "/jsp/lessonDetails.jsp", "/jsp/questionDetail.jsp",
                        "/jsp/questionImport.jsp","/jsp/questionList.jsp",
                        "/jsp/quizDetail.jsp", "/jsp/quizList.jsp",
...
public class CourseFeatureFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("CourseFeatureFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CourseFeatureFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("CourseFeatureFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("CourseFeatureFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CourseFeatureFilter()");
        }
        StringBuffer sb = new StringBuffer("CourseFeatureFilter(");
