...
public class CustomerExclusiveFilter implements Filter {
     ...
     * Blank constructor
     */
    public CustomerExclusiveFilter() {
    }
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("CustomerExclusiveFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CustomerExclusiveFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("CustomerExclusiveFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("CustomerExclusiveFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CustomerExclusiveFilter()");
        }
        StringBuffer sb = new StringBuffer("CustomerExclusiveFilter(");
